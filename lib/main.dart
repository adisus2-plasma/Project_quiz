...
class _QuizAppState extends State<QuizApp> {
  ...
  Future<void> _loadAssets() async {
    await Future.wait([
      ...
      precacheImage(const AssetImage('assets/images/food_quiz_only.webp'), context),
      precacheImage(const AssetImage('assets/images/story4_bt.png'), context),
      precacheImage(const AssetImage('assets/images/mall1_bg.gif'), context),
      precacheImage(const AssetImage('assets/images/mall23.gif'), context),
