...
void main() => runApp(StoryPage9(answers: []));

class StoryPage9 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPage9({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => QuizPage8(answers: answers), // ✅ ส่งต่อ
