...
void main() => runApp(StoryPageCafe1(answers: []));

class StoryPageCafe1 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPageCafe1({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'คุณกับเพื่อน\nเดินเที่ยวเล่นกันสักพัก(คาเฟ่1)',
                  style: TextStyle(
                    fontSize: 24,
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => StoryPageCafe2(answers: answers), // ✅ ส่งต่อ
                      ),
                    );
                  },
