...
class StoryPageThemePark4 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPageThemePark4({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
