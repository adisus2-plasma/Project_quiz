...
import 'package:project_quiz/result_page.dart';

void main() => runApp(StoryPage8(answers: []));

class StoryPage8 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPage8({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => ResultPage(answers: answers), // ✅ ส่งต่อ
