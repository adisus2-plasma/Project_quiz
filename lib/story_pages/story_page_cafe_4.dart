...
void main() => runApp(StoryPageCafe4(answers: []));

class StoryPageCafe4 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPageCafe4({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
