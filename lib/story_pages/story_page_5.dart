...
import '../quiz_pages/quiz_page_2.dart';

void main() => runApp(StoryPage5(answers: []));

class StoryPage5 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPage5({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => QuizPage2(answers: answers), // ✅ ส่งต่อ
