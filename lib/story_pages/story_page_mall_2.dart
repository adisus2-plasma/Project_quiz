...
void main() => runApp(StoryPageMall2(answers: []));

class StoryPageMall2 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPageMall2({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
