...
import 'package:project_quiz/quiz_pages/quiz_page_5.dart';

void main() => runApp(StoryPage6(answers: []));

class StoryPage6 extends StatelessWidget {
  final List<Map<String, int>> answers;
  const StoryPage6({super.key, required this.answers}); // ชื่อ class ต้องตรงกับที่เรียกใช้
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => QuizPage5(answers: answers), // ✅ ส่งต่อ
                      ),
                    );
                  },
